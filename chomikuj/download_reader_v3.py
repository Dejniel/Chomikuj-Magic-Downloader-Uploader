...
class DownloadReaderV3(ChomikujBase):
    ...
    def download_url(self, file_id):
        ...
        # TODO: Do not add a suspicious-transfer skip to v3 blindly.
        ...
        # visible in v3 at all, so there is nothing reliable to compare or
        # skip on the v3 path yet. Revisit only after finding a real
        # v3-visible file whose transfer cost can be observed and verified
        # end-to-end.
